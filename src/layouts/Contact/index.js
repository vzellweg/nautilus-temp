...
class Contact extends Component {
  ...
  handleSubmit(event) {
    ...
    const json = JSON.stringify({
      ...
      _subject: '[Nautilus Surf Shop] Message Received',
      _format: 'plain'
    });
  ...
  sendFormData(json) {
    ...
    xmlhttp.open('POST', 'https://formspree.io/info@nautilusurf.com', true);
    ...
    xmlhttp.onreadystatechange = function() {
      ...
      // 4 = Response from server has been completely loaded.
        ...
        if ( xmlhttp.status === 200 && xmlhttp.status < 300 ) {
          ...
          _this.setState({ alert: { show: true, type: 'danger', text: 'Sorry, there has been an error. Please send your message to info@natilusurf.com'} });
        }
      }
    };
  }
